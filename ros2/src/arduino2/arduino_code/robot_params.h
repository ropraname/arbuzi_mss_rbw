...
// НОВОЕ: Максимально допустимое отставание мотора от профиля в тиках
// Если мотор отстанет сильнее, робот начнет "притормаживать" общую траекторию
constexpr int MAX_TRACKING_ERROR = 30; // Подбери экспериментально (20-50 обычно идеально)
